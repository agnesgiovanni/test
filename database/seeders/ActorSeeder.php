...
class ActorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '88.4',
            'birthday' => '1967-08-21',
            'place_of_brith' => 'Vancouver, British Columbia, Canada'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '90.2',
            'birthday' => '1977-09-15',
            'place_of_brith' => 'Hammersmith, London, England, UK'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '87.7',
            'birthday' => '1961-07-23',
            'place_of_brith' => 'Midland, Texas, USA'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '83.5',
            'birthday' => '1992-03-13',
            'place_of_brith' => 'Holloway, London, England, UK'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '86.4',
            'birthday' => '1960-07-22',
            'place_of_brith' => 'Bogotá, Colombia'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '82.6',
            'birthday' => '1955-05-13',
            'place_of_brith' => 'Medellín, Colombia'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '90.2',
            'birthday' => '1996-06-01',
            'place_of_brith' => 'Kingston upon Thames, England, UK'
        ]);
        ...
        DB::table('actors')->insert([
            ...
            'popularity' => '90.4',
            'birthday' => '1996-09-1',
            'place_of_brith' => 'Oakland, California, USA'
        ]);
